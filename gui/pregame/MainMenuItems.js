var g_MainMenuItems = [
		...
		"submenu": [
			{
				...
				"tooltip": translate("Open the Hyrule Conquest Game Manual."),
				"onPress": () => {
			...
			{
				"caption": translate("Ancient Wisdom"),
				"tooltip": translate("Discover the secrets of the ancient Hylians."),
				"onPress": () => {
			...
			},
			{
				...
				"tooltip": colorizeHotkey(translate("%(hotkey)s: View the structure tree of civilizations featured in Hyrule Conquest"), "structree"),
				"hotkey": "structree",
	...
	},
	{
		...
		"tooltip": translate("Play through fantastical military campaigns."),
		"onPress": () => {
			try
			{
	...
	},
	{
		...
		"tooltip": translate("Fight against one or more human (or otherwise...) players in a multiplayer game."),
		"submenu": [
			{
	...
	{
		"caption": translate("Hyrule Conquest: Revival Info"),
		"tooltip": translate("Info about Hyrule Conquest: Revival."),
		"onPress": () => {
			Engine.PushGuiPage("page_HC_info.xml");
			}
	},
	{
		...
		"submenu": [
			...
			},
			{
				...
				"tooltip": translate("Select and download other mods for the game."),
				"onPress": () => {
