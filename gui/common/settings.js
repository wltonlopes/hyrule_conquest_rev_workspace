...
function loadAIDifficulties()
{
	return [
		...
		{
			"Name": "very easy",
			"Title": translateWithContext("aiDiff", "Pathetic")
		},
		{
			"Name": "easy",
			"Title": translateWithContext("aiDiff", "Wimpy")
		},
		{
			"Name": "medium",
			"Title": translateWithContext("aiDiff", "Average"),
			"Default": true
		},
		{
			"Name": "hard",
			"Title": translateWithContext("aiDiff", "Heroic")
		},
		{
			"Name": "very hard",
			"Title": translateWithContext("aiDiff", "Titan")
		}
	];
}
