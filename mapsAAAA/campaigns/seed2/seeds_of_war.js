...
var defendTime = () => randFloat(10, 10);//25minutes long
...
{
	let infIntrudersB = ["units/deku/infantry_archer_b","units/deku/infantry_spearman_b"]
...
{
	let infIntrudersC = ["units/deku/infantry_archer_b","units/deku/infantry_spearman_b"]
	var intruders = TriggerHelper.SpawnUnitsFromTriggerPoints(
			pickRandom(["C"]),pickRandom(infIntrudersC), 10, 0);
...
cmpTrigger.DoAfterDelay(80000, "AttackII", {});
cmpTrigger.DoAfterDelay(80000, "AttackII", {});
cmpTrigger.DoAfterDelay(180000, "IntroductionMessage", {});
