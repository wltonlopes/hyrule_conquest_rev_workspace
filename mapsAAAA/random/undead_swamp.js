...
var oReDead = "gaia/stalfos_redead";
var oStalchild = "gaia/stalfos_stalchild";
var oStaltroop = "gaia/stalfos_staltroop";
var oPoe = "gaia/stalfos_poe";
...
g_Map.log("Creating undead");
createObjectGroups(
	new SimpleGroup([new SimpleObject(oReDead, 3, 4, 2, 5)], false, clFood),
	0,
	avoidClasses(clPlayer, 25, clFood, 10),
	20 * numPlayers, 100);
	
createObjectGroups(
	new SimpleGroup([new SimpleObject(oStalchild, 3, 4, 2, 5)], false, clFood),
	0,
	avoidClasses(clPlayer, 20, clFood, 10),
	40 * numPlayers, 200);
	
createObjectGroups(
	new SimpleGroup([new SimpleObject(oStaltroop, 3, 4, 2, 5)], false, clFood),
	0,
	avoidClasses(clPlayer, 20, clFood, 10),
	30 * numPlayers, 150);
	
createObjectGroups(
	new SimpleGroup([new SimpleObject(oPoe, 1, 1, 0, 1)], false, clFood),
	0,
	avoidClasses(clPlayer, 30),
	5 * numPlayers, 50);
