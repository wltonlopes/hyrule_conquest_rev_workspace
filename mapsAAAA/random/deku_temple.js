...
function* GenerateMap()
{
	...
	const templateTemple = "structures/deku/wonder";
	const templateDefenders = "gaia/deku_megascrub";
	...
	const terrainWoodBorder = [
		...
		'temp_grass_plants|gaia/deku_scrubling',
		"temp_grass_long_b|gaia/deku_spearman",
		"temp_grass_plants"
	];
	...
	const terrainHillBorder = [
		...
		"temp_cliff_b",
		"temp_dirt_gravel_plants",
		"temp_highlands|gaia/fauna_deer"
	];
	...
	g_Map.log("Placing temple defender1");
	g_Map.placeEntityPassable(templateDefenders, 0, mapCenter, randomAngle());
	clBaseResource.add(mapCenter);
	
	g_Map.log("Placing temple defender2");
	g_Map.placeEntityPassable(templateDefenders, 0, mapCenter, randomAngle());
	clBaseResource.add(mapCenter);
	
	g_Map.log("Placing temple defender3");
	g_Map.placeEntityPassable(templateDefenders, 0, mapCenter, randomAngle());
	clBaseResource.add(mapCenter);
	
	g_Map.log("Placing temple defender4");
	g_Map.placeEntityPassable(templateDefenders, 0, mapCenter, randomAngle());
	clBaseResource.add(mapCenter);
	
	g_Map.log("Placing temple defender5");
	g_Map.placeEntityPassable(templateDefenders, 0, mapCenter, randomAngle());
	clBaseResource.add(mapCenter);
	
	g_Map.log("Placing temple defender6");
	g_Map.placeEntityPassable(templateDefenders, 0, mapCenter, randomAngle());
	clBaseResource.add(mapCenter);
	
	g_Map.log("Placing temple defender7");
	g_Map.placeEntityPassable(templateDefenders, 0, mapCenter, randomAngle());
	clBaseResource.add(mapCenter);
	
	g_Map.log("Placing temple defender8");
	g_Map.placeEntityPassable(templateDefenders, 0, mapCenter, randomAngle());
	clBaseResource.add(mapCenter);
