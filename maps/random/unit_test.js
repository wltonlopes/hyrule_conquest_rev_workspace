...
function* GenerateMap(mapSettings)
{
	...
	const oUnderling = "structures/destructible_vinewall_dekuA";
	const oBaba = "structures/destructible_vinewall_dekuA";
	const oPikit = "structures/destructible_vinewall_dekuA";
	const oDeku = "structures/destructible_rock_desertA";
	const oScrub = "structures/destructible_rock_desertA";
	const oDeer = "gaia/fauna_deer";
	const oBeetle = "structures/destructible_rock_desertA";
