...
HYRULE.answerRequestAttackMessages = {
	"join": [
...
HYRULE.answerDiplomacyRequestMessages = {
	"ally": {
		"decline": [
...
HYRULE.sendDiplomacyRequestMessages = {
	"ally": {
		"sendRequest": [
...
HYRULE.chatLaunchAttack = function(gameState, player, type)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
		"message": "/allies " + pickRandom(this.launchAttackMessages[type === HYRULE.AttackPlan.TYPE_HUGE_ATTACK ? "hugeAttack" : "other"]),
...
HYRULE.chatAnswerRequestAttack = function(gameState, player, answer, other)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
HYRULE.chatSentTribute = function(gameState, player)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
HYRULE.chatRequestTribute = function(gameState, resource)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
HYRULE.chatNewTradeRoute = function(gameState, player)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
HYRULE.chatNewPhase = function(gameState, phase, status)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
HYRULE.chatNewDiplomacy = function(gameState, player, newDiplomaticStance)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
HYRULE.chatAnswerRequestDiplomacy = function(gameState, player, requestType, response, requiredTribute)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
HYRULE.chatNewRequestDiplomacy = function(gameState, player, requestType, status)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
		"message": "/msg " + gameState.sharedScript.playersData[player].name + " " +
...
HYRULE.chatEmergency = function(gameState, enable)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
