HYRULE.TrainingPlan = function(gameState, type, metadata, number = 1, maxMerge = 5)
{
...
HYRULE.TrainingPlan.prototype = Object.create(HYRULE.QueuePlan.prototype);

HYRULE.TrainingPlan.prototype.canStart = function(gameState)
{
...
HYRULE.TrainingPlan.prototype.getBestTrainers = function(gameState)
{
...
HYRULE.TrainingPlan.prototype.start = function(gameState)
{
	if (this.metadata && this.metadata.trainer)
	{
		let metadata = {};
	...
	if (this.trainers.length > 1)
	{
		...
		const workerUnit = this.metadata && this.metadata.role && this.metadata.role === HYRULE.Worker.ROLE_WORKER;
...
HYRULE.TrainingPlan.prototype.addItem = function(amount = 1)
{
	this.number += amount;
};

HYRULE.TrainingPlan.prototype.Serialize = function()
{
	return {
...
HYRULE.TrainingPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
