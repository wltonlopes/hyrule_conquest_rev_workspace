...
HYRULE.QueuePlan = function(gameState, type, metadata)
{
	...
	if (!this.template)
	{
		API3.warn("Tried to add the inexisting template " + this.type + " to HYRULE.");
		return false;
	}
...
HYRULE.QueuePlan.prototype.isInvalid = function(gameState)
{
	return false;
};

/** if true, the queue manager will begin increasing this plan's account. */
HYRULE.QueuePlan.prototype.isGo = function(gameState)
{
	return true;
};

/** can we start this plan immediately? */
HYRULE.QueuePlan.prototype.canStart = function(gameState)
{
	return false;
};

/** process the plan. */
HYRULE.QueuePlan.prototype.start = function(gameState)
{
	// should call onStart.
};

HYRULE.QueuePlan.prototype.getCost = function()
{
 ...
 */
HYRULE.QueuePlan.prototype.onStart = function(gameState)
{
};
