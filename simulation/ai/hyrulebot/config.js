...
HYRULE.DIFFICULTY_EASY = 2;
HYRULE.DIFFICULTY_MEDIUM = 3;
HYRULE.DIFFICULTY_HARD = 4;
HYRULE.DIFFICULTY_VERY_HARD = 5;

HYRULE.Config = function(difficulty = HYRULE.DIFFICULTY_MEDIUM, behavior)
{
	...
	this.Military = {
		...
		"fortressLapseTime": 4000,	// Time to wait between building 2 fortresses
		"popForBarracks1": 30,
		"popForBarracks2": 100,
		"popForForge": 40,
		"numSentryTowers": 2
	...
	this.Economy = {
		...
		"popForDock": 30,
		"targetNumWorkers": 50,	// dummy, will be changed later
	...
	this.Defense =
	{
		"defenseRatio": { "ally": 1.4, "neutral": 1.6, "own": 2 },	// ratio of defenders/attackers.
	...
	this.priorities =
	{
		"villager": 50,      // should be slightly lower than the citizen soldier one to not get all the food
		"citizenSoldier": 80,
		"trader": 20,
		"healer": 30,
		"ships": 70,
		...
		"dock": 80,
		"corral": 80,
		"economicBuilding": 100,
		"militaryBuilding": 150,
		"defenseBuilding": 100,
		"civilCentre": 950,
		"majorTech": 700,
		"minorTech": 250,
	...
	// See HYRULE.QueueManager.prototype.wantedGatherRates()
	this.queues =
	{
		"firstTurn": {
			"food": 20,
...
HYRULE.Config.prototype.setConfig = function(gameState)
{
	if (this.difficulty > HYRULE.DIFFICULTY_SANDBOX)
	{
		...
		let personalityList = {
			"random": { "min": 0, "max": 1 },
			"defensive": { "min": 0.60, "max": 1.20 },
			"balanced": { "min": 0.50, "max": 1 },
			"aggressive": { "min": 0.40, "max": 0.80 }
		};
	...
	// HYRULE usually uses the continuous values of personality.aggressive and personality.defensive
	...
	if (this.difficulty < HYRULE.DIFFICULTY_EASY)
	{
		this.popScaling = 0.5;
	...
	else if (this.difficulty < HYRULE.DIFFICULTY_MEDIUM)
	{
		this.popScaling = 0.7;
	...
	{
		if (this.difficulty == HYRULE.DIFFICULTY_MEDIUM)
	...
	if (this.debug < 2)
		return;
	API3.warn(" >>>  HYRULE bot: personality = " + uneval(this.personality));
};

HYRULE.Config.prototype.Cheat = function(gameState)
{
...
HYRULE.Config.prototype.Serialize = function()
{
	var data = {};
	for (let key in this)
...
HYRULE.Config.prototype.Deserialize = function(data)
{
	for (let key in data)
		this[key] = data[key];
};
