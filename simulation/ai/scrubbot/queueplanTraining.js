SCRUB.TrainingPlan = function(gameState, type, metadata, number = 1, maxMerge = 5)
{
...
SCRUB.TrainingPlan.prototype = Object.create(SCRUB.QueuePlan.prototype);

SCRUB.TrainingPlan.prototype.canStart = function(gameState)
{
...
SCRUB.TrainingPlan.prototype.getBestTrainers = function(gameState)
{
...
SCRUB.TrainingPlan.prototype.start = function(gameState)
{
	if (this.metadata && this.metadata.trainer)
	{
		let metadata = {};
	...
	if (this.trainers.length > 1)
	{
		...
		const workerUnit = this.metadata && this.metadata.role && this.metadata.role === SCRUB.Worker.ROLE_WORKER;
...
SCRUB.TrainingPlan.prototype.addItem = function(amount = 1)
{
	this.number += amount;
};

SCRUB.TrainingPlan.prototype.Serialize = function()
{
	return {
...
SCRUB.TrainingPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
