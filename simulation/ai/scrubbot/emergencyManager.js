 ...
 */
SCRUB.EmergencyManager = function(Config)
{
	this.Config = Config;
...
SCRUB.EmergencyManager.prototype.init = function(gameState)
{
...
SCRUB.EmergencyManager.prototype.update = function(gameState)
{
...
SCRUB.EmergencyManager.prototype.emergencyUpdate = function(gameState)
{
	const pop = gameState.getPopulation();
	const nStructures = gameState.getOwnStructures().length;
	const nRoots = this.rootCount(gameState);
...
SCRUB.EmergencyManager.prototype.rootCount = function(gameState)
{
	let roots = 0;
...
SCRUB.EmergencyManager.prototype.setEmergency = function(gameState, enable)
{
	this.hasEmergency = enable;
	SCRUB.chatEmergency(gameState, enable);
};

SCRUB.EmergencyManager.prototype.Serialize = function()
{
	return {
...
SCRUB.EmergencyManager.prototype.Deserialize = function(data)
{
