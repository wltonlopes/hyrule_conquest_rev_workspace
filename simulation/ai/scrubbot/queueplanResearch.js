SCRUB.ResearchPlan = function(gameState, type, rush = false)
{
	if (!SCRUB.QueuePlan.call(this, gameState, type, {}))
		return false;
...
SCRUB.ResearchPlan.prototype = Object.create(SCRUB.QueuePlan.prototype);

SCRUB.ResearchPlan.prototype.canStart = function(gameState)
{
...
SCRUB.ResearchPlan.prototype.getBestResearchers = function(gameState, noRequirementCheck = false)
{
...
SCRUB.ResearchPlan.prototype.isInvalid = function(gameState)
{
	return gameState.isResearched(this.type) || gameState.isResearching(this.type);
};

SCRUB.ResearchPlan.prototype.start = function(gameState)
{
...
SCRUB.ResearchPlan.prototype.onStart = function(gameState)
{
...
SCRUB.ResearchPlan.prototype.Serialize = function()
{
	return {
...
SCRUB.ResearchPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
