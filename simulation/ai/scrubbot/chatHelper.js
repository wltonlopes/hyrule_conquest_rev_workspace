...
SCRUB.answerRequestAttackMessages = {
	"join": [
...
SCRUB.answerDiplomacyRequestMessages = {
	"ally": {
		"decline": [
...
SCRUB.sendDiplomacyRequestMessages = {
	"ally": {
		"sendRequest": [
...
SCRUB.chatLaunchAttack = function(gameState, player, type)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
		"message": "/allies " + pickRandom(this.launchAttackMessages[type === SCRUB.AttackPlan.TYPE_HUGE_ATTACK ? "hugeAttack" : "other"]),
...
SCRUB.chatAnswerRequestAttack = function(gameState, player, answer, other)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
SCRUB.chatSentTribute = function(gameState, player)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
SCRUB.chatRequestTribute = function(gameState, resource)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
SCRUB.chatNewTradeRoute = function(gameState, player)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
SCRUB.chatNewPhase = function(gameState, phase, status)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
SCRUB.chatNewDiplomacy = function(gameState, player, newDiplomaticStance)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
SCRUB.chatAnswerRequestDiplomacy = function(gameState, player, requestType, response, requiredTribute)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
...
SCRUB.chatNewRequestDiplomacy = function(gameState, player, requestType, status)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
		"message": "/msg " + gameState.sharedScript.playersData[player].name + " " +
...
SCRUB.chatEmergency = function(gameState, enable)
{
	Engine.PostCommand(PlayerID, {
		"type": "aichat",
