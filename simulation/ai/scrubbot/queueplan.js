...
SCRUB.QueuePlan = function(gameState, type, metadata)
{
	...
	if (!this.template)
	{
		API3.warn("Tried to add the inexisting template " + this.type + " to SCRUB.");
		return false;
	}
...
SCRUB.QueuePlan.prototype.isInvalid = function(gameState)
{
	return false;
};

/** if true, the queue manager will begin increasing this plan's account. */
SCRUB.QueuePlan.prototype.isGo = function(gameState)
{
	return true;
};

/** can we start this plan immediately? */
SCRUB.QueuePlan.prototype.canStart = function(gameState)
{
	return false;
};

/** process the plan. */
SCRUB.QueuePlan.prototype.start = function(gameState)
{
	// should call onStart.
};

SCRUB.QueuePlan.prototype.getCost = function()
{
 ...
 */
SCRUB.QueuePlan.prototype.onStart = function(gameState)
{
};
