...
SCRUB.QueueManager = function(Config, queues)
{
	this.Config = Config;
	this.queues = queues;
	this.priorities = {};
...
SCRUB.QueueManager.prototype.getAvailableResources = function(gameState)
{
...
SCRUB.QueueManager.prototype.getTotalAccountedResources = function()
{
...
SCRUB.QueueManager.prototype.currentNeeds = function(gameState)
{
...
// TODO: many things.
SCRUB.QueueManager.prototype.wantedGatherRates = function(gameState)
{
...
SCRUB.QueueManager.prototype.printQueues = function(gameState)
{
	let numWorkers = 0;
...
SCRUB.QueueManager.prototype.clear = function()
{
	for (let i in this.queues)
		this.queues[i].empty();
};
 ...
 */
SCRUB.QueueManager.prototype.setAccounts = function(gameState, cost, i)
{
 ...
 */
SCRUB.QueueManager.prototype.transferAccounts = function(cost, i, j)
{
	for (let res of Resources.GetCodes())
	{
 ...
 */
SCRUB.QueueManager.prototype.distributeResources = function(gameState)
{
	...
	for (let res of Resources.GetCodes())
	{
		...
		if (available < 0)
			API3.warn("SCRUB: problem with remaining " + res + " in queueManager " + available);
	}
};

SCRUB.QueueManager.prototype.switchResource = function(gameState, res)
{
...
SCRUB.QueueManager.prototype.startNextItems = function(gameState)
{
	for (let q of this.queueArrays)
	{
		let name = q[0];
...
SCRUB.QueueManager.prototype.update = function(gameState)
{
...
SCRUB.QueueManager.prototype.checkPausedQueues = function(gameState)
{
	const numWorkers = gameState.countOwnEntitiesAndQueuedWithRole(SCRUB.Worker.ROLE_WORKER);
...
SCRUB.QueueManager.prototype.canAfford = function(queue, cost)
{
...
SCRUB.QueueManager.prototype.pauseQueue = function(queue, scrapAccounts)
{
...
SCRUB.QueueManager.prototype.unpauseQueue = function(queue)
{
	if (this.queues[queue])
		this.queues[queue].paused = false;
};

SCRUB.QueueManager.prototype.pauseAll = function(scrapAccounts, but)
{
	for (let q in this.queues)
	{
		if (q == but)
...
SCRUB.QueueManager.prototype.unpauseAll = function(but)
{
	for (let q in this.queues)
		if (q != but)
...
SCRUB.QueueManager.prototype.addQueue = function(queueName, priority)
{
	if (this.queues[queueName] !== undefined)
		return;

	this.queues[queueName] = new SCRUB.Queue();
...
SCRUB.QueueManager.prototype.removeQueue = function(queueName)
{
	if (this.queues[queueName] === undefined)
		return;
...
SCRUB.QueueManager.prototype.getPriority = function(queueName)
{
	return this.priorities[queueName];
};

SCRUB.QueueManager.prototype.changePriority = function(queueName, newPriority)
{
...
SCRUB.QueueManager.prototype.Serialize = function()
{
	let accounts = {};
	let queues = {};
	for (let q in this.queues)
...
SCRUB.QueueManager.prototype.Deserialize = function(gameState, data)
{
