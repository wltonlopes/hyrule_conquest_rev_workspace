GORO.ResearchPlan = function(gameState, type, rush = false)
{
	if (!GORO.QueuePlan.call(this, gameState, type, {}))
		return false;
...
GORO.ResearchPlan.prototype = Object.create(GORO.QueuePlan.prototype);

GORO.ResearchPlan.prototype.canStart = function(gameState)
{
...
GORO.ResearchPlan.prototype.getBestResearchers = function(gameState, noRequirementCheck = false)
{
...
GORO.ResearchPlan.prototype.isInvalid = function(gameState)
{
	return gameState.isResearched(this.type) || gameState.isResearching(this.type);
};

GORO.ResearchPlan.prototype.start = function(gameState)
{
...
GORO.ResearchPlan.prototype.onStart = function(gameState)
{
...
GORO.ResearchPlan.prototype.Serialize = function()
{
	return {
...
GORO.ResearchPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
