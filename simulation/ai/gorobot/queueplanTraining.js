GORO.TrainingPlan = function(gameState, type, metadata, number = 1, maxMerge = 5)
{
...
GORO.TrainingPlan.prototype = Object.create(GORO.QueuePlan.prototype);

GORO.TrainingPlan.prototype.canStart = function(gameState)
{
...
GORO.TrainingPlan.prototype.getBestTrainers = function(gameState)
{
...
GORO.TrainingPlan.prototype.start = function(gameState)
{
	if (this.metadata && this.metadata.trainer)
	{
		let metadata = {};
	...
	if (this.trainers.length > 1)
	{
		...
		const workerUnit = this.metadata && this.metadata.role && this.metadata.role === GORO.Worker.ROLE_WORKER;
...
GORO.TrainingPlan.prototype.addItem = function(amount = 1)
{
	this.number += amount;
};

GORO.TrainingPlan.prototype.Serialize = function()
{
	return {
...
GORO.TrainingPlan.prototype.Deserialize = function(gameState, data)
{
	for (let key in data)
		this[key] = data[key];
