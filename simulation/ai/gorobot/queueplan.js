...
GORO.QueuePlan = function(gameState, type, metadata)
{
	...
	if (!this.template)
	{
		API3.warn("Tried to add the inexisting template " + this.type + " to GORO.");
		return false;
	}
...
GORO.QueuePlan.prototype.isInvalid = function(gameState)
{
	return false;
};

/** if true, the queue manager will begin increasing this plan's account. */
GORO.QueuePlan.prototype.isGo = function(gameState)
{
	return true;
};

/** can we start this plan immediately? */
GORO.QueuePlan.prototype.canStart = function(gameState)
{
	return false;
};

/** process the plan. */
GORO.QueuePlan.prototype.start = function(gameState)
{
	// should call onStart.
};

GORO.QueuePlan.prototype.getCost = function()
{
 ...
 */
GORO.QueuePlan.prototype.onStart = function(gameState)
{
};
