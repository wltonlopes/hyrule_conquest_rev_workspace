 ...
 */
GORO.EmergencyManager = function(Config)
{
	this.Config = Config;
...
GORO.EmergencyManager.prototype.init = function(gameState)
{
...
GORO.EmergencyManager.prototype.update = function(gameState)
{
...
GORO.EmergencyManager.prototype.emergencyUpdate = function(gameState)
{
	const pop = gameState.getPopulation();
	const nStructures = gameState.getOwnStructures().length;
	const nRoots = this.rootCount(gameState);
...
GORO.EmergencyManager.prototype.rootCount = function(gameState)
{
	let roots = 0;
...
GORO.EmergencyManager.prototype.setEmergency = function(gameState, enable)
{
	this.hasEmergency = enable;
	GORO.chatEmergency(gameState, enable);
};

GORO.EmergencyManager.prototype.Serialize = function()
{
	return {
...
GORO.EmergencyManager.prototype.Deserialize = function(data)
{
